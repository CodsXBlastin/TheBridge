			...
			if(isset($args[0])){
				switch(strtolower($args[0])){
					...
					if(isset($args[1])){
						...
						$sender->sendMessage("§l§o§eT§6B§r §bits /tb mode {map} {solo\teams\squad}");
						return true;
					}
					break;
					case "help":
			$sender->sendMessage("§l§eTHE§6BRIDGE§r");
			$sender->sendMessage("§e[1]§bhelp");
			$sender->sendMessage("§e[2]§bjoin");
			$sender->sendMessage("§e[3]§bcreate");
			$sender->sendMessage("§e[4]§bdelete");
			$sender->sendMessage("§c§lSETUP");
			$sender->sendMessage("§e[5]§bpos1§7(§ablue teams soul§7)");
			$sender->sendMessage("§e[6]§bpos2§7(§6red teams soul§7)");
			$sender->sendMessage("§e[7]§bspawn§7(§aWhen the player join! I Recommend setting up a lobby§7)");
			$sender->sendMessage("§e[8]§bspawn1§7(§3blue team spawn§7)");
			$sender->sendMessage
("§e[9]§bspawn2§7(§ered team spawn§7)");
			$sender->sendMessage
("§e[10]§brespawn1§7(§ablue team respawn when dead§7)");
			$sender->sendMessage
("§e[11]§brespawn2§7(§6red team respawn when dead§7)");
